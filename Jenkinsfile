    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'master', 
                    credentialsId: 'github-credentials-projet-maven2', 
                    url: 'https://github.com/Lucas-MARIE/HelloWorldMaven.git' // ❗ Votre URL
                echo "Dépôt cloné."
            }
        }
        stage('Build') {
    ...
    post {
        ...
        success {
            script {
                ...
                withCredentials([
                    ...
                    def gitRepoUrl = "https://github.com/Lucas-MARIE/HelloWorldMaven.git" // ❗ MODIFIER CETTE URL
        ...
        failure {
            script {
                ...
                def tagName = "V-1.${env.BUILD_NUMBER}-failure"
                ...
                withCredentials([
                    ...
                    def gitRepoUrl = "https://github.com/Lucas-MARIE/HelloWorldMaven.git"
                    def gitPushUrl = "https://${GIT_USER}:${GIT_TOKEN}@${gitRepoUrl.split('//')[1]}"
                    sh "git push ${gitPushUrl} ${tagName}"
                }
            }
